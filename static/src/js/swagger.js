...
spec.paths["/plugins/paypal/projects/{id_project}/{password}/whitelist"] = {
    "post": {
        "tags": [
            "Project",
        ],
...
spec.paths["/plugins/paypal/job/{id_job}/{password}/instructions"] = {
    "get": {
        "tags": [
            "Job",
        ],
...
spec.paths["/plugins/paypal/job/{id_job}/{password}/segments/{segments_ids}"] = {
    "get": {
        "tags": [
            "Job",
        ],
...
spec.paths["/api/v1/new"].post.parameters.push( {
    "name": "instructions",
    "type": "string",
